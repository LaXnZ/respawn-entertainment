                    ...
                    <div class="col-md-12">
                        <div class="cart">
                            <div class="card-holder">
                                <div class="row">
                                    <div class="col-md-6 text-3xl font-extrabold"> Add New User </div>
                                   ...
                                   <div class="mb-3 mt-3"> 
                                    ...
                                    <div class="mb-3 mt-3"> 
                                      ...
                                      <div class="mb-3 mt-3"> 
                                        ...
                                        <input type="tel" name="phone" class="form-control" placeholder="Enter User's Phone Number" >
                                        @error('phone')
                                            <p class="text-danger">{{$message}}</p>
                                        @enderror
                                    </div>
                                    <div class="mb-3 mt-3"> 
                                        <label for="address" class="form-label"> User's Home Address </label>
                                        <input type="text" name="address" class="form-control" placeholder="Enter User's Address" >
                                        @error('address')
                                            <p class="text-danger">{{$message}}</p>
                                        @enderror
                                    </div>
                                    <div class="mb-3 mt-3"> 
                                        <label for="dob" class="form-label"> User's Date of Birth </label>
                                        <input type="date" name="dob" class="form-control" placeholder="Enter User's Date of Birth" >
                                        @error('dob')
                                            <p class="text-danger">{{$message}}</p>
                                        @enderror
                                    </div>
