                    ...
                    <div class="cart">
                        <div class="card-holder">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6"><a href="{{ route('product.create') }}"
                                        class="btn btn-success float-end"> Add New Product</a></div>
                            </div>
                        </div>
                        <div class="card-body">
                                ...
                                <tbody>
                                    @if ($product->count() > 0)
                                        @foreach ($product as $rs)
                                            <tr>
                                                <td>{{ $rs->id }}</td>
                                                <td><img src="{{ asset('assets/imgs/product_crud/') }}/{{ $rs->image }}"
                                                        width="400" /></td>
                                                <td>{{ $rs->name }}</td>
                                                <td>{{ $rs->slug }}</td>
                                                ...
                                                <td>
                                                    <div class="flex h-auto">
                                                        ...
                                                        <form action="{{ route('product.destroy', $rs->id) }}"
