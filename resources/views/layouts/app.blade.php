...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <div>
          ...
          <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  ...
                  <ul class="text-gray-500 dark:text-gray-400 font-medium">
                      ...
                      <li class="mb-4">
                          <a href="#" class="hover:underline">Cafes</a>
                      </li>
                      <li class="mb-4">
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
          <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://github.com/LaXnZ/respawn-entertainment" class="hover:underline">Respawn Entertainment ™</a>. All Rights Reserved.
          </span>
